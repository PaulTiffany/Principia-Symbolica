...
A symbolic universe \(\mathcal{U}\) supports bounded reflexive emergence for
\(\mathcal{O}\) when there exist horizon components \(H_G,H_D\) meeting a
common nonempty observer domain \(\Omega_{\mathcal{O}}\) such that
\[
G_{\mathcal{O}}(H_G)>0,\qquad C_{\mathcal{O}}(H_D)>0,
\]
and the mixed emergence functional
\[
\Delta\Phi_{\mathcal{O}}(D,R_{\mathrm{stab}})
  :=G_{\mathcal{O}}(H_G)\,C_{\mathcal{O}}(H_D)
\]
exceeds an observer threshold \(\tau_E>0\). The positive factor supplies
observer-visible novelty; the negative factor supplies stabilizing reflective
closure through \(R_{\mathrm{stab}}\)
...
(cf.~Proof~\ref{proof:bk1_colimit_yields_categoric_structure}). Then
\(\mathcal{U}\) supports bounded reflexive emergence for \(\mathcal{O}\) iff it
possesses an effective dual horizon structure:
\[
\Sigma_{\mathcal{O}}(\mathcal{U})=\{+,-\}
\]
with generative and dissipative fluxes satisfying
\[
\Delta\Phi_{\mathcal{O}}(D,R_{\mathrm{stab}})\geq \tau_E.
\]
Equivalently, reflexive emergence requires at least one observer-visible
positive-curvature novelty channel and at least one
negative-curvature stabilization channel on a shared bounded domain.
\end{theorem}
...
\textbf{Necessity.}
Assume \(\mathcal{U}\) supports bounded reflexive emergence for
\(\mathcal{O}\). By Def.~\ref{definition:bk1_bounded_reflexive_emergence},
there are horizon components \(H_G,H_D\) on a common nonempty
\(\Omega_{\mathcal{O}}\) with
\[
G_{\mathcal{O}}(H_G)>0,\qquad C_{\mathcal{O}}(H_D)>0.
\]
By Def.~\ref{definition:bk1_effective_horizon_signature}, this is exactly the
statement that \(+\in\Sigma_{\mathcal{O}}(\mathcal{U})\) and
\(-\in\Sigma_{\mathcal{O}}(\mathcal{U})\). Hence
\(\Sigma_{\mathcal{O}}(\mathcal{U})=\{+,-\}\). The same definition gives
\(\Delta\Phi_{\mathcal{O}}(D,R_{\mathrm{stab}})\geq\tau_E\).

\textbf{Failure of single-sign signatures.}
If \(+\notin\Sigma_{\mathcal{O}}(\mathcal{U})\), then
\(G_{\mathcal{O}}(H)=0\) for every horizon component visible to
\(\mathcal{O}\), so no observer-visible novelty channel exists and
\(\Delta\Phi_{\mathcal{O}}=0\). If
\(-\notin\Sigma_{\mathcal{O}}(\mathcal{U})\), then
\(C_{\mathcal{O}}(H)=0\) for every visible horizon component, so no
stabilizing reflective closure channel exists and again
\(\Delta\Phi_{\mathcal{O}}=0\). If neither sign is present, both failures
hold. A constant nonzero drift field does not evade this conclusion: without
positive horizon flux paired with negative stabilization flux it supplies
transport, not bounded reflexive emergence.

\textbf{Sufficiency.}
Conversely, assume \(\Sigma_{\mathcal{O}}(\mathcal{U})=\{+,-\}\) and
\(\Delta\Phi_{\mathcal{O}}(D,R_{\mathrm{stab}})\geq\tau_E\). By the definition
of the effective signature, there exist visible horizon components \(H_G,H_D\)
with \(G_{\mathcal{O}}(H_G)>0\) and \(C_{\mathcal{O}}(H_D)>0\). The positive
flux supplies novelty-generation through drift \(D\)
(Def.~\ref{definition:bk1_drift_field}); the negative flux supplies
state-level stabilization through \(R_{\mathrm{stab}}\)
(Def.~\ref{definition:bk1_reflection_operator};
Cor.~\ref{corollary:bk1_fixed_point}). Since the mixed emergence functional
meets the threshold \(\tau_E\), all clauses of
Def.~\ref{definition:bk1_bounded_reflexive_emergence} are satisfied. Therefore
\(\mathcal{U}\) supports bounded reflexive emergence.
\end{proof}
