...
\item \textbf{Drift--reflection interplay:} the drift field $D$, the reflection
operator $R$, and the symbolic flow $\Phi_s$ on the manifold $M$
(Defs.~\ref{definition:bk1_drift_field}, \ref{definition:bk1_reflection_operator},
\ref{definition:bk1_symbolic_flow}, \ref{definition:bk1_symbolic_manifold}).
\end{enumerate}
