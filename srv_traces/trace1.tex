...
\begin{figure}[htbp]
\centering
\caption[\textit{SRV trace (summary)}]{\textit{This SRV trace simulates symbolic behavior structurally consistent with Axiom~\ref{axiom:bk1_axiomata_prima}, Definition~\ref{definition:bk1_bounded_observer}, and Lemma~\ref{lemma:bk1_local_stability_analysis}, modeling drift emergence within a symbolic probability manifold.}}
