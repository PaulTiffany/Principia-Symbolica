...
\begin{figure}[htbp]
\centering
\caption[\textit{SRV trace (summary)}]{\textit{This SRV trace simulates symbolic behavior structurally consistent with Definition~\ref{definition:bk2_symbolic_free_energy}, Lemma~\ref{lemma:bk2_finiteness_of_symbolic_entropy}, and Axiom~\ref{axiom:bk2_symbolic_fokker_planck_equation}. It integrates phase transitions in drift–reflection convergence.}}
