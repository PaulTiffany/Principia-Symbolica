...
\begin{figure}[htbp]
\centering
\caption[\textit{SRV trace (summary)}]{\textit{This SRV trace simulates symbolic behavior structurally consistent with Axiom~\ref{axiom:bk2_symbolic_fokker_planck_equation}, Definition~\ref{definition:bk1_symbolic_flow}, and Lemma~\ref{lemma:bk4_srmf_constrained_action_norm}, showing coherent symbolic flow across drift and reflection regimes.}}
