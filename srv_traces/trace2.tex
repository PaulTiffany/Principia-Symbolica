...
\begin{figure}[htbp]
\centering
\caption[\textit{SRV trace (summary)}]{\textit{This SRV trace simulates symbolic behavior structurally consistent with Definition~\ref{definition:bk2__symbolic_probability_density} and Lemma~\ref{lemma:bk2_finiteness_of_symbolic_entropy}, demonstrating entropy growth from symbolic probability dynamics.}}
