...
Conditionally on the explicitly stated observer and non-contextuality premises, we derive the Born probability rule from the
...
\subsection{Observer Data Structures in the Quantum Regime}
...
\subsection{Interpretive-Budget Additivity from Bounded Discernibility}
...
\subsection{Coherence Axioms (PS–C)}
...
\subsection{Interpretation Within Principia Symbolica}
...
\subsection{Critique of the Entropic Arrow}
...
\subsection{The Geometric Engine of Irreversibility}
